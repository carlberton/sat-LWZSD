...
def test_instance(cnf_filepath, cryptominisat_dir, timeout=None):
    """
    Teste une instance CNF avec cryptominisat et renvoie le résultat, le temps d'exécution et la solution.
    Si timeout est None, le script attend indéfiniment.
    """
    try:
        # Chemin vers l'exécutable cryptominisat
        ...
        print(f"Erreur lors de l'exécution de cryptominisat : {e}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test des instances CNF avec cryptominisat.")
    ...
    parser.add_argument('--cryptominisat', type=str, required=True, help="Répertoire de cryptominisat.")
